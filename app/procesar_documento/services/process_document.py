...
class ProcessDocument:
    def __init__(
        ...
        self._query_id: str | None = query_id
        self._document_chain: str = document_chain
    ...
    def load_document(self) -> None:
        ...
        self._document_bytes = base64.b64decode(self._document_chain)
    ...
    def process_document(
        ...
        logger.info(f"{self._document_title} ingestado en vdb")
        return True
    ...
    def _transform_doc_with_metadata(self) -> list[Document]:
        ...
        logger.info(f"{self._document_title} transformado a documento con metadata")
        return documents
    ...
    def _load_embeddings_service(
        self, embeddings_model: str | None = "text-embedding-ada-002"
    ) -> None:
    ...
    def _load_chroma_vbd(self, collection_name: str = "rag-docs") -> Chroma:
        ...
        try:
            ...
            logger.info(f"Coleccion {collection_name} existente")
        except Exception as e:
            logger.error(f"Coleccion no existente {collection_name}:::{e}")
